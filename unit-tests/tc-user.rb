...
class TC_UserTest < MiniTest::Test
    ...
    def test_locked_init
        new_user = EntryCrypto::User.new "dgascon", 1234, "this is some special secret"
    ...
    def test_unlocking_user
        new_user = EntryCrypto::User.new "dgascon", 1234, "this some special secret"
        new_user.lock("password1234")
    ...
    def test_adding_locked_user
        new_user = EntryCrypto::User.new "dgascon", 1234, "this is some special secret"
        new_user.lock("23423490hasdfasldvn01243")
        assert_raises(EntryCrypto::LockedError) { new_user.add_new_entry("www.google.ca", "dgascon", "password1234") }
    ...
    def test_finding_locked_user_entry
        ...
        new_user.lock("23423490hasdfasldvn01243")
        # Now get an entry
        assert_raises(EntryCrypto::LockedError) { new_user.get_website_user_password "www.google.ca", "dgascon" }
 
    end

    def test_secret_generation
        new_user = EntryCrypto::User.new "dgascon", 1234, nil
